  ...
  <div class="row">
    <div class="col-md mx-auto">
      <div class="card card-body bg-light mt-5">
        ...
        <form action="<?php echo URLROOT;?>/cars/update" method="POST">
          <div class="form-row">
          ...
          <div class="form-row">
            ...
            <div class="col">
              <a href="<?php echo URLROOT; ?>/cars/delete/<?php  echo $data['car_id'];?>" class="btn btn-light btn-block">To cars list</a>
            </div>
          </div>
        </form>
      </div>
